...
public class StudentPageA extends AppCompatActivity {
    ...
    ImageView logoutOptionsButton,AdminListA;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudentGuidelinesA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openLatestUpdatedFile("guidelinesA/guidelines.pdf", "Guidelines.pdf");
            }
        });
        StudentFoodMenuA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openLatestUpdatedFile("menusA/menu.pdf", "FoodMenu.pdf");
            }
        });
        ...
        StudentNoticeA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(StudentPageA.this,StudentNoticeA.class);
                startActivity(intent);
            }
        });
        ...
        StudentComplaintsA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(StudentPageA.this,StudentCompA.class);
                startActivity(intent);
            }
        });
        AdminListA=findViewById(R.id.AdminListA);
        AdminListA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(StudentPageA.this,AdminDataA.class);
                startActivity(intent);
            }
        });
    ...
    private void openLatestUpdatedFile(String storagePath, String customName) {
        ...
        fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
            ...
            if (!downloadUrl.isEmpty()) {
                ...
                Toast.makeText(StudentPageA.this, "No PDF available", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(e -> {
            Toast.makeText(StudentPageA.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
        });
    }
    @Override
